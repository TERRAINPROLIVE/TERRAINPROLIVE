      ...
      <AnimatePresence>
        {!open && (
          <motion.button
            ...
            className="fixed bottom-[104px] right-4 sm:bottom-4 z-40 w-11 h-11 rounded-full bg-[#F5A623] text-black grid place-items-center shadow-[0_8px_24px_rgba(0,0,0,0.45)] hover:brightness-110 active:scale-95 transition-all"
          >
