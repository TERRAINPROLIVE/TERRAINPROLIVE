    ...
    >
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-8 pb-20 sm:pb-28 pt-32 w-full">
        <motion.span
          ...
          className="inline-block mb-5 bg-yellow-500 text-black text-xs font-black tracking-widest uppercase px-3 py-1 rounded-sm"
        >
          #1 Quoting Tool for Aussie Tradies
        </motion.span>
